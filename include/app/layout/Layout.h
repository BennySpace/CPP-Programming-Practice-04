...
struct SceneLayout {
    ...
    static constexpr int kCurbCount = 20;
    static constexpr float kCurbX = 54.0f;
...
struct StatusBarLayout {
    ...
    static constexpr float kBannerTitleX = 1002.0f;
    static constexpr float kBannerTitleY = 58.0f;
    static constexpr float kBannerTextX = 1002.0f;
    static constexpr float kBannerTextY = 80.0f;
    static constexpr float kBannerTextWidth = 340.0f;
